...
export async function generateMetadata({ params: { slug } }) {
  return {
    title: `${slug} movies and series watch`,
    description: `download ${slug} ott platform movies and series for free in 480p,720p,1080p and 4K and hindi dubbed in vegamovies | filmyzila | hdmovies`,
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_URL}/ott/${slug}`,
    },
    robots: {
      index: true,
      follow: true,
