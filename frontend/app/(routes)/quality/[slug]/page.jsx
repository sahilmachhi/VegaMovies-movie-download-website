...
export async function generateMetadata({ params: { slug } }) {
  return {
    title: `${slug} quality movies and series`,
    description: `download ${slug} quality movies and series for free in hindi dubbed in vegamovies | filmyzila | hdmovies`,
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_URL}/quality/${slug}`,
    },
    robots: {
      index: true,
      follow: true,
