...
export async function generateMetadata({ params: { slug } }) {
  return {
    title: `${slug} movies watch online`,
    description: `download ${slug} movies for free in 480p,720p,1080p and 4K and hindi dubbed in vegamovies | filmyzila | hdmovies`,
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_URL}/genre/${slug}`,
    },
    robots: {
      index: true,
      follow: true,
