...
export async function generateMetadata({ params: { slug } }) {
  return {
    title: `watch ${slug} for free`,
    description: `download ${slug} for free in 480p,720p,1080p and 4K and hindi dubbed in vegamovies | filmyzila | hdmovies`,
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_URL}/type/${slug}`,
    },
    robots: {
      index: true,
      follow: true,
